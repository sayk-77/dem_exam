    ...
    public partial class AdminWindow : Form
    {
        ...
        private void DeleteProduct(string article)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Продукт с данным артикулом не найден.");
                }
            }
            catch (MySqlException ex)
            {
        ...
        {
            if (listProduct.CurrentRow == null) MessageBox.Show("Продукт не выбран");
            
            string currentProductArticleNumber = listProduct.CurrentRow.Cells["Артикул"].Value.ToString();
            DeleteProduct(currentProductArticleNumber);
        }

        private void changeProduct_Click(object sender, EventArgs e)
        {
            string currentProduct;
            if (listProduct.CurrentRow != null)
            {
                currentProduct = listProduct.CurrentRow.Cells["Артикул"].Value.ToString();
            }
            else
            {
            ...
            ChangeProduct cw = new ChangeProduct(currentProduct);
            cw.ShowDialog();
            LoadProduct();
        }
